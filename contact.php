		  ...
		  <div class="prod_box_big">
			...
			<div class="center_prod_box_big">
			 ...
			 <div class='companyfeedback'>
				 ...
				 <span class="blue"><li>Joining Online Bidding System cost Ksh 300 for the membership. Our then current Fees and Credit Policies for selling
				 item are available at Online Bidding system. Unless otherwise stated, all fees are quoted in Kenyan Ksh. You are responsible for paying
		 ...
		 <div class="developer">
		  ...
		  <div class="prod_box_big">
			...
			<div class="center_prod_box_big">
							...
							<div class="welcsub"><center><p> <p></center></div>
				<div class='logreg'>
					<div class="loginb">
						<div class="top_prod_box"></div>
						<div class="center_prod_box">
				...
				<div class='developer'>
					<div class="loginc">
					<br><br>					
					<span class="blue">Jared Fwaya</span>   
					<br><br>					 					
				</div>
			  </div>
			   </div>
