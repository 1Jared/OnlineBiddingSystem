...
<script type='text/javascript'>
	...
	$con=mysqli_connect('localhost', 'root', '', 'biddingsystemdb');
		$userid = $_SESSION['ID'];
		$query = mysqli_query($con,"SELECT * FROM member WHERE memberid = '$userid'") or die (mysqli_error());
	...
	mysqli_query($con,"INSERT INTO products(prodname,categoryid,prodescription,startingbid,prodimage,dateposted,duedate,status,sellername,sellerpayaccount) 
          ...
          <div class="details_big_box">
            ...
            <div class="specifications">
			 ...
			 <div id="regstep1">
				...
				mysqli_query($con,"UPDATE member SET lastname='$last_save', firstname='$fname_save', gender='$gender_save', address='$address_save', birthdate='$bday_save' WHERE memberid='$userid'") or die (mysqli_error());
           ...
           <strong>Contact:</strong> 
			...
			mysqli_query($con,"UPDATE member SET password='$password_save', memberimg='$name' WHERE memberid='$userid'") or die(mysqli_error());
				...
				<div class="specifications">
					...
					<div class='hidenotif'>
						<div class="thumbs">
							...
							error_reporting(E_ALL);
							$con=mysqli_connect('localhost', 'root', '', 'biddingsystemdb');
								$get = mysqli_query($con,"SELECT * FROM needtopay WHERE needtopay.memberid = '$userid' AND needtopay.status=0")or die(mysqli_error());
								while($getit = mysqli_fetch_array($get)){
								$prod = $getit['productid'];
								$getprod = mysqli_query($con,"SELECT * FROM products WHERE productid = '$prod'")or die(mysqli_error());
