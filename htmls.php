<?php
	function headhtml(){
	  ...
	  <script type="text/javascript">
			...
			<div id="main_container">
			  ...
			  <div id="header">
				<div id="logo"> <a href="#"><img src="images/Bidding.jpg" alt="" border="0" width="237" height="140" /></a> </div>
	...
	function foothtml(){
		echo ' <div class="footer">
				<div class="left_footer"> <img src="images/onlineBid.png" alt="" width="170" height="49"/> </div>
				<div class="center_footer"> Online Bidding System<br />
		
				  <img src="images/mpesa.png" alt="MPESA" width="60"/> </div>
